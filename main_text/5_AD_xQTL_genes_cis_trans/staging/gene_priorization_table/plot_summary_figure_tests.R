...
res_adx[context_short=='Mic caQTL']
...
contexts_order<-c('Exc eQTL','Inh eQTL','Oli eQTL','OPC eQTL','Ast eQTL','Ast caQTL','Mic eQTL','Mic caQTL','bMic eQTL','bMac eQTL','bMono eQTL','bulk eQTL',
...
contexts_order<-c('Exc eQTL','Inh eQTL','Oli eQTL','OPC eQTL','Ast eQTL','Ast caQTL',
                  'Mic eQTL','Mic caQTL',
                  'Immune eQTL',
                  'bulk eQTL',
                  'bulk sQTL',
...
res_adxlocfge_cont_topf[,gene_name_2:=ifelse(!all(only_by_proxi,na.rm = T),paste0("<b>",gene_name_2[1],'</b>'),
                                                    gene_name_2[1]),
                        by='gene_name']
...
res_adxlocfge_cont_topf[,gene_name_3:=paste0(gene_name_2,' (',n_gwas_gene,')'),
                        by='gene_name']

res_adxlocfge_cont_topf$gene_name_3|>unique()


#add number of loci


res_adxlocfge_cont_topf[,gene_name_4:=paste0(gene_name_2,ifelse(n_loci_gene>1,'*',''),' (',n_gwas_gene,')'),
                        by='gene_name']

res_adxlocfge_cont_topf$gene_name_4|>unique()


res_adxlocfge_cont_topf[,gene_name_4:=factor(gene_name_4,levels = unique(gene_name_4[order(gene_name)]))]
