...
res_adxlocfge_cont_top<-unique(res_adxlocfge,by=c('gene_name','context_group'))[gene_name%in%gene_name[confidence_lvl%in%c('C1','C2','C3','C4')]]
...
res_adxlocfge_cont_topf[is.na(context_group)][,.(context)]|>unique()
